            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                <Card className="border border-black/10">
                    <Card.Header className="items-center text-center space-y-3">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-amber-200">
                            <IoIosSunny size={24} className="text-amber-600" />
                        </div>
                        <Card.Title className="font-bold text-xl">
                            Sun Protection
                        </Card.Title>
                        <Card.Description>
                            Apply SPF 50+ sunscreen every 2 hours for optimal
                            protection
                        </Card.Description>
                    </Card.Header>
                </Card>
                ...
                <Card className="border border-black/10">
                    <Card.Header className="items-center text-center space-y-3">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-200">
                            <MdWaterDrop size={24} className="text-blue-600" />
                        </div>
                        <Card.Title className="font-bold text-xl">
                            Stay Hydrated
                        </Card.Title>
                        <Card.Description>
                            Drink at least 8 glasses of water daily during hot
                            weather
                        </Card.Description>
                    </Card.Header>
                </Card>
                ...
                <Card className="border border-black/10">
                    <Card.Header className="items-center text-center space-y-3">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-pink-200">
                            <FaRegHeart size={24} className="text-pink-600" />
                        </div>
                        <Card.Title className="font-bold text-xl">
                            Skin Care
                        </Card.Title>
                        <Card.Description>
                            Moisturize after sun exposure to keep skin healthy
                        </Card.Description>
                    </Card.Header>
                </Card>
                ...
                <Card className="border border-black/10">
                    <Card.Header className="items-center text-center space-y-3">
                        ...
                        <Card.Description>
                            Wear breathable, light-colored fabrics to stay cool
                        </Card.Description>
                    </Card.Header>
                </Card>
            </div>
