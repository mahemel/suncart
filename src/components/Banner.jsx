...
const Banner = () => {
    return (
        <div>
            <div className="relative w-full h-75 sm:h-100 md:h-125 rounded-lg md:rounded-2xl overflow-hidden shadow-2xl">
                <Image
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 sm:px-8 md:px-12">
                    <div className="bg-yellow-300 text-orange-900 px-3 py-1 sm:px-6 sm:py-2 rounded-full mb-3 sm:mb-6 shadow-lg">
                        <span className="font-bold tracking-wide text-xs sm:text-base">
                            LIMITED TIME OFFER
                        </span>
                    </div>
                    ...
                    <button className="bg-white text-orange-600 px-6 py-3 sm:px-12 sm:py-5 rounded-full text-sm sm:text-xl font-bold hover:bg-yellow-300 hover:text-orange-900 transition-all duration-300 shadow-2xl hover:scale-105">
                        SHOP NOW
                    </button>
                </div>
            </div>
